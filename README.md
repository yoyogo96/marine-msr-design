...
[![AI Generated](https://img.shields.io/badge/Code-100%25%20AI%20Generated-red.svg)]()

---

> **Important Disclaimer | 중요 고지사항**
>
> **이 저장소의 모든 코드, 해석 모델, 설계 파라미터, 보고서는 100% 인공지능(Claude, Anthropic)에 의해 자체 생성되었습니다.** 인간 엔지니어가 어떠한 원자로 설계 데이터, 독점 기술 정보, 또는 비공개 핵 데이터를 입력하거나 제공한 사실이 없습니다. 모든 물리 모델과 수치는 AI가 공개된 교과서, 학술 논문, ORNL 공개 보고서 등의 일반 지식을 기반으로 독립적으로 구성한 것입니다.
>
> **All code, analysis models, design parameters, and reports in this repository were generated entirely by artificial intelligence (Claude by Anthropic).** No human engineer provided any proprietary reactor design data, classified nuclear information, or non-public technical data as input. All physics models and numerical values were independently constructed by the AI based on general knowledge from publicly available textbooks, academic papers, and declassified ORNL reports.
>
> - 본 프로젝트는 **교육 및 연구 목적**의 개념 탐색용이며, 실제 원자로 건설이나 인허가에 사용할 수 없습니다.
> - 단면적 데이터는 ENDF/B-VIII.0 **공개 데이터**에서 AI가 근사한 것으로, 정밀 핵설계 코드(MCNP, Serpent 등)의 결과가 아닙니다.
> - This project is for **educational and research exploration** only and cannot be used for actual reactor construction or licensing.
> - Cross-section data was approximated by AI from publicly available ENDF/B-VIII.0 data, not from precision nuclear design codes (MCNP, Serpent, etc.).
...
This is an **AI-generated design analysis package** for educational and research purposes. Contributions welcome:
...
- **Note**: All original code was generated by Claude (Anthropic AI). Human contributions are welcomed for validation and improvement.
...
```bibtex
@software{msr_marine_2026,
  title={40 MWth Marine Molten Salt Reactor Design Analysis Package},
  author={AI-Generated (Claude, Anthropic)},
  year={2026},
  url={https://github.com/yoyogo96/marine-msr-design},
  note={100\% AI-generated code and analysis, no human-provided design data}
}
```
...
이 프로젝트는 **Anthropic의 Claude AI**가 공개 문헌만을 참조하여 100% 자율적으로 생성한 것입니다. 어떠한 인간 엔지니어의 독점 설계 데이터 입력도 없었으며, 모든 물리 모델은 AI가 아래 공개 자료를 기반으로 독립 구성하였습니다:

This project was **100% autonomously generated by Claude AI (Anthropic)** referencing only publicly available literature. No proprietary design data was provided by any human engineer. All physics models were independently constructed by AI based on the following open sources:

- ORNL public reports (ORNL-4541, ORNL/TM-2006/12, etc.) on MSRE/MSBR programs
- ENDF/B-VIII.0 publicly available evaluated nuclear data
- Standard nuclear engineering textbooks (Duderstadt & Hamilton, Lamarsh, etc.)
- ASME Boiler & Pressure Vessel Code (publicly available standards)
- DNV GL ship classification rules

**기술 유출 관련 (Regarding Technology Export Concerns)**:
본 저장소에는 어떠한 비공개, 기밀, 또는 수출 통제 대상 기술 정보도 포함되어 있지 않습니다. 모든 내용은 AI가 공개된 학술 자료로부터 생성한 교육용 근사 모델입니다.

This repository contains NO classified, proprietary, or export-controlled technical information. All content consists of educational approximate models generated by AI from publicly available academic sources.

---

**Last Updated**: February 2026
**Status**: Conceptual & Basic Design Complete, Detailed Design Phase Pending
**Generated By**: Claude (Anthropic AI) - 100% AI-generated, zero human design data input
